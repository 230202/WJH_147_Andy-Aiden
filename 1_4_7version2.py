...
def custom(original_image, color,frame_width):
    ...
    0 < framewidth < 1
    is the frame border as a portion of the shorter dimension of original_image
    """
    ...
    drawing_layer.polygon([(thickness,thickness,),(height * 1/5,thickness),(thickness, width * 1/5)], fill=(r,g,b,255))
    drawing_layer.polygon([(width - thickness,1/5 * height - thickness),(width,4/5*height),(height,4/5*width)], fill=(r,g,b,255))
    #drawing_layer.polygon([(width-thickness,height-thickness),(4/5*width - thickness, height - thickness),(width-thickness,4/5*height-thickness)], fill=(r,g,b,255))
    #drawing_layer.rectangle()
    
    # Make the new image, starting with all transparent
    result = original_image.copy()
    result.paste(framed_mask, (0,0), mask=framed_mask)
